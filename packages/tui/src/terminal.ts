		...
		if (terminal) {
			...
			process.stdout.write(
				"\x1b[?2026l" + // End synchronized output
					...
					"\x1b[?1006l\x1b[?1003l\x1b[?1000l" + // Disable fullscreen or normal-screen mouse tracking
...
export class ProcessTerminal implements Terminal {
	...
	stop(): void {
		...
		// Disable mouse tracking (enabled by fullscreen overlays or an opted-in
		// normal screen; safe no-ops otherwise). Covers crash paths that reach
		// stop() without the TUI's own teardown running.
