 ...
 *
 * Mouse tracking is used by fullscreen overlays and, when a host opts in, by
 * the normal screen. Coordinates are exposed 0-based so fullscreen components
 * can hit-test directly against frames painted from screen row 0 and normal-
 * screen consumers can route reports without repeating protocol decoding.
 */
